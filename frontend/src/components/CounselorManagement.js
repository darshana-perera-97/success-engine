...
const CounselorManagement = ({ students, employees, tasks, onTransferStudents, onAddActivity }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-8 animate-in fade-in duration-500 pb-10", children: [
    ...
    isAddModalOpen && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-2xl w-full max-w-md border border-gray-100 scale-100 animate-in zoom-in-95 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("form", { className: "p-5 space-y-4", onSubmit: handleAddCounselor, children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("option", { children: "Colombo HQ" }),
                    /* @__PURE__ */ jsx("option", { children: "Kandy" }),
                    /* @__PURE__ */ jsx("option", { children: "Galle" }),
                    /* @__PURE__ */ jsx("option", { children: "Jaffna" })
                  ]
                }
              )
            ] })
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-slate-500 uppercase mb-1", children: "Role" }),
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx(Briefcase, { className: "absolute left-3 top-2.5 text-slate-400", size: 16 }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  name: "role",
                  ...
                  children: [
                    /* @__PURE__ */ jsx("option", { children: "Senior Counselor" }),
                    /* @__PURE__ */ jsx("option", { children: "Junior Counselor" }),
                    /* @__PURE__ */ jsx("option", { children: "Team Lead" })
                  ]
                }
              )
            ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-2 pt-4 border-t border-gray-100", children: [
          /* @__PURE__ */ jsx(Button, { variant: "ghost", type: "button", onClick: () => setIsAddModalOpen(false), children: "Cancel" }),
          /* @__PURE__ */ jsx(Button, { type: "submit", className: "bg-indigo-600 hover:bg-indigo-700 text-white", children: "Create Profile" })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: [
      ...
      /* @__PURE__ */ jsx(MetricCard, { title: "Avg SLA Score", value: `${Math.round(counselors.reduce((acc, c) => acc + c.metrics.sla, 0) / counselors.length)}%`, icon: /* @__PURE__ */ jsx(CheckCircle, { size: 18 }), color: "text-emerald-600" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-[#D32722] via-[#BF342F] to-[#883560] p-5 rounded-xl text-white shadow-lg relative overflow-hidden flex items-center gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-white rounded-xl flex-shrink-0 overflow-hidden shadow-sm border-2 border-white/20", children: /* @__PURE__ */ jsx(
          "img",
          {
            src: "/8.jpg",
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-white/80 text-xs font-bold uppercase tracking-wider mb-1", children: [
            /* @__PURE__ */ jsx(Star, { size: 14, className: "text-yellow-400", fill: "currentColor" }),
            " Top Performer"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "text-xl font-bold", children: "Nethmini Julanjala" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-white/90 font-medium mt-0.5", children: "3 Visas Granted" })
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm text-left", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100", children: filteredCounselors.map((c) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50 transition-colors group", children: [
        ...
        /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-right", children: /* @__PURE__ */ jsxs(Button, { size: "sm", variant: "secondary", onClick: () => setSelectedCounselorId(c.id), children: [
          "View ",
