...
import { Employee, Student, Task, UniversityRule, ActivityLog, Message, UniversityProgram, Invoice, Appointment } from './types';
...
export const UNIVERSITY_RULES: UniversityRule[] = [
    { name: "Monash University", country: "Australia", minGPA: 3.0, minIELTS: 6.5, ranking: 42, requiredDocs: ['Reference Letter'] },
    { name: "Seneca College", country: "Canada", minGPA: 2.5, minIELTS: 6.0, ranking: 1500, requiredDocs: [] },
    { name: "University of Greenwich", country: "UK", minGPA: 2.5, minIELTS: 6.0, ranking: 800, requiredDocs: ['Reference Letter'] },
    ...
    { name: "Deakin University", country: "Australia", minGPA: 2.7, minIELTS: 6.0, ranking: 266, requiredDocs: ['SOP'] },
];

export const UNIVERSITY_PROGRAMS: UniversityProgram[] = [
    { id: "UP001", university: "University of Greenwich", programName: "MSc Data Science", country: "UK", tuition: 18200, currency: "GBP", duration: "1 Year", intake: "Sept / Jan", minGPA: 2.5, minIELTS: 6.0, ranking: 800, tags: ["London Campus", "Placement Year"], logoColor: "bg-blue-900" },
    { id: "UP002", university: "Teesside University", programName: "MSc Data Science", country: "UK", tuition: 16500, currency: "GBP", duration: "1 Year", intake: "Sept / Jan", minGPA: 2.2, minIELTS: 6.0, ranking: 1000, tags: ["Affordable", "Regional"], logoColor: "bg-rose-700" },
    { id: "UP003", university: "University of West London", programName: "MSc Data Science", country: "UK", tuition: 17800, currency: "GBP", duration: "1 Year", intake: "Sept / Feb", minGPA: 2.5, minIELTS: 6.0, ranking: 600, tags: ["Modern Facilities"], logoColor: "bg-gray-800" },
    { id: "UP004", university: "University of Manchester", programName: "MSc Data Science", country: "UK", tuition: 32000, currency: "GBP", duration: "1 Year", intake: "Sept", minGPA: 3.5, minIELTS: 7.0, ranking: 50, tags: ["Russell Group", "Top Tier"], logoColor: "bg-purple-900" },
    { id: "UP005", university: "Monash University", programName: "Master of Data Science", country: "Australia", tuition: 48000, currency: "AUD", duration: "2 Years", intake: "Feb / July", minGPA: 3.0, minIELTS: 6.5, ranking: 42, tags: ["Go8", "Post-Study Work"], logoColor: "bg-slate-900" },
    { id: "UP006", university: "Seneca College", programName: "Business Analytics", country: "Canada", tuition: 19000, currency: "CAD", duration: "1 Year", intake: "Sept / Jan / May", minGPA: 2.5, minIELTS: 6.5, ranking: 1500, tags: ["PGWP Eligible", "Co-op"], logoColor: "bg-red-600" },
    ...
    { id: "UP008", university: "Arizona State University", programName: "MS Computer Science", country: "USA", tuition: 28000, currency: "USD", duration: "2 Years", intake: "Aug / Jan", minGPA: 3.2, minIELTS: 6.5, ranking: 150, tags: ["STEM Designated", "Scholarships"], logoColor: "bg-amber-700" },
];
...
export const INVOICES: Invoice[] = [
    { id: "INV-2026-001", studentId: "STU1001", amount: 25000, currency: "LKR", description: "Registration Fee", issueDate: "2026-02-01", dueDate: "2026-02-15", status: "Paid", generatedReceiptUrl: "#" },
    { id: "INV-2026-002", studentId: "STU1001", amount: 150000, currency: "LKR", description: "Visa Pilot Fee (Installment 1)", issueDate: "2026-02-20", dueDate: "2026-02-27", status: "Pending" },
    ...
    { id: "INV-2026-004", studentId: "STU1003", amount: 45000, currency: "LKR", description: "Courier & Translation Charges", issueDate: "2026-02-25", dueDate: "2026-02-28", status: "Pending" }
];
...
export const APPOINTMENTS: Appointment[] = [
    ...
    { id: 'APT002', counselorId: 'EMP002', studentId: 'STU1007', title: 'Visa Document Check', date: '2026-02-24', time: '14:00', duration: 30, type: 'Visa Check', status: 'Scheduled' }, // Past date for "Review" testing
    ...
    { id: 'APT007', counselorId: 'EMP004', studentId: 'STU1001', title: 'Team Performance Review', date: '2026-02-28', time: '16:00', duration: 60, type: 'Counseling', status: 'Scheduled' } // Manager's own appointment
];

export const COUNTRY_CHECKLISTS: Record<string, { stage: string; items: { docType: string; description: string }[] }[]> = {
  'Australia': [
    {
      stage: 'Documentation',
      items: [
